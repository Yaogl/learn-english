 ...
 */
const REALMS = [
  { id: 'lianqi', name: '练气', icon: '🌱', desc: '初入仙途，感应灵气', color: '#8ab0a0', maxStage: 9 },
  { id: 'zhuji', name: '筑基', icon: '🏔️', desc: '奠定根基，凝聚真元', color: '#9eb0c9', maxStage: 9 },
  { id: 'jindan', name: '金丹', icon: '✨', desc: '凝结金丹，脱胎换骨', color: '#c9b896', maxStage: 9 },
  { id: 'yuanying', name: '元婴', icon: '👶', desc: '元婴出世，神通初显', color: '#c9a882', maxStage: 9 },
  { id: 'huashen', name: '化神', icon: '🔥', desc: '化神入道，天地共鸣', color: '#b8a9c9', maxStage: 9 },
  { id: 'heti', name: '合体', icon: '🌀', desc: '天人合一，掌控法则', color: '#b8a898', maxStage: 9 },
  { id: 'dacheng', name: '大乘', icon: '🌟', desc: '大乘圆满，超凡入圣', color: '#c9a8b4', maxStage: 9 },
  { id: 'dujie', name: '渡劫', icon: '⚡', desc: '渡劫飞升，成就大道', color: '#c9958a', maxStage: 9 },
];
